...
const styles = StyleSheet.create({ page: { flex: 1, backgroundColor: "#081E37" }, top: { paddingTop: 10, paddingHorizontal: 16, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, badge: { flexDirection: "row", alignItems: "center", gap: 5, paddingVertical: 7, paddingHorizontal: 10, backgroundColor: "#173451", borderRadius: 15 }, badgeText: { color: "#B7D9F9", fontSize: 11, fontWeight: "800" }, placeholderTop: { width: 42 }, stage: { flex: 1, overflow: "hidden", marginHorizontal: 16, marginTop: 16, borderRadius: 26, backgroundColor: "#102E50", borderWidth: 1, borderColor: "#214363" }, remoteVideo: { flex: 1 }, remoteFallback: { flex: 1, alignItems: "center", justifyContent: "center" }, initials: { color: "#B8DBFF", fontSize: 74, fontWeight: "900", letterSpacing: -6 }, waiting: { color: "#B4C8DD", marginTop: 12, fontSize: 13 }, localVideo: { position: "absolute", right: 16, top: 16, width: 96, height: 132, borderRadius: 16, overflow: "hidden", borderWidth: 2, borderColor: "#FFFFFF" }, nameBox: { alignItems: "center", paddingTop: 15, paddingBottom: 12 }, peerTitle: { color: "#FFFFFF", fontWeight: "900", fontSize: 18 }, callState: { color: "#AAC6E4", marginTop: 4, fontSize: 12 }, controls: { minHeight: 82, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 28, paddingHorizontal: 24, paddingTop: 4, paddingBottom: 18 }, control: { alignItems: "center", gap: 5 }, controlLabel: { color: "#CBDCEA", fontSize: 10, fontWeight: "700" }, end: { width: 60, height: 52, alignItems: "center", justifyContent: "center", borderRadius: 20, backgroundColor: "#E5484D", shadowColor: "#000000", shadowOpacity: 0.2, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 4 }, incomingControls: { minHeight: 78, flexDirection: "row", justifyContent: "center", alignItems: "center", gap: 12, paddingHorizontal: 20, paddingBottom: 20 }, reject: { paddingVertical: 14, paddingHorizontal: 22, borderRadius: 15, backgroundColor: "#E5484D" }, accept: { paddingVertical: 14, paddingHorizontal: 22, borderRadius: 15, backgroundColor: "#19A974" }, controlText: { color: "#FFFFFF", fontSize: 13, fontWeight: "900" }, pressed: { opacity: 0.62 } });
