...
import { ActivityIndicator, Animated, FlatList, Image, KeyboardAvoidingView, Platform, Pressable, StyleSheet, Text, TextInput, View } from "react-native";
...
function MessageBubble({ message, isMine, onDownload, onRevoke, onForward }: { message: MobileMessage; isMine: boolean; onDownload: () => void; onRevoke: () => void; onForward: () => void }) {
