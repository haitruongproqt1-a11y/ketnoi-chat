...
import { ActivityIndicator, Animated, FlatList, Image, KeyboardAvoidingView, PanResponder, Platform, Pressable, StyleSheet, Text, TextInput, View } from "react-native";
...
function MessageBubble({ message, isMine, onDownload, onRevoke, onForward, onReply }: { message: MobileMessage; isMine: boolean; onDownload: () => void; onRevoke: () => void; onForward: () => void; onReply: () => void }) {
